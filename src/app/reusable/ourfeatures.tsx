    ...
    <div className="">
      ...
      <div className="flex max-w-5xl justify-center text-center mx-auto md:mb-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
          <div className="size-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-800">
          ...
          <div className="size-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-800">
            ...
            <p className="text-gray-600 dark:text-neutral-400">
              Import applicants directly from LinkedIn to accelerate your recruitment process.
            </p>
          </div>
